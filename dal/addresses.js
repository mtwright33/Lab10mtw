...
exports.GetByID = function(c_id, callback) {
    console.log(c_id);
    var query = 'SELECT * FROM addresses WHERE c_id=' + c_id;
    console.log(query);
...
/* NOTE: Just like functions in other languages the parameters sent to a function do not need to have the same names
 ...
 this function.
 */
exports.Insert = function(caddress_info, callback) {
     ...
     */
    var dynamic_query = 'INSERT INTO addresses (c_id, cname, staddress, city, zip, state) VALUES (' +
        '\'' + caddress_info.c_id + '\', ' +
        '\'' + caddress_info.cname + '\', ' +
        '\'' + caddress_info.staddress + '\', ' +
        '\'' + caddress_info.city + '\'' +
        '\'' + caddress_info.zip + '\'' +
        '\'' + caddress_info.state + '\'' +
        ');';
