...
exports.Insert = function(company_info, callback) {
     ...
     */
    var dynamic_query = 'INSERT INTO company (cname, numsub) VALUES (' +
        '\'' + company_info.cname + '\', ' +
        '\'' + company_info.numsub + '\', ' +
        ');';
...
exports.Update = function(company_info, callback) {
    var query_data = [company_info.cname, company_info.numsub];
    var query = 'UPDATE company SET cname = ?, numsub = ? WHERE company_id = ?';
...
exports.Delete = function(c_id, callback) {
    var query = 'DELETE FROM company WHERE c_id = ' + c_id;
