...
exports.GetBysID = function(s_id, callback) {
    console.log(s_id);
    var query = 'SELECT * FROM school WHERE s_id=' + s_id;
    console.log(query);
...
exports.Insert = function(school_info, callback) {
     ...
     */
    var dynamic_query = 'INSERT INTO school (s_id, sname, staddress, city, zip, state) VALUES (' +
        '\'' + school_info.s_id + '\', ' +
        '\'' + school_info.sname + '\', ' +
        '\'' + school_info.staddress + '\', ' +
        '\'' + school_info.city + '\'' +
        ');';
